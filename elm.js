...
var _user$project$Main$viewTimezone = F2(
	function (time, r) {
		var hour = function (zdt) {
			return function (x) {
				return A2(_elm_lang$core$Basics_ops['++'], x, ':00');
			}(
				_elm_lang$core$Basics$toString(
					_elm_community$elm_time$Time_ZonedDateTime$hour(zdt)));
		};
		var label = A2(
			_elm_lang$html$Html$td,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('tz-label'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_elm_community$elm_time$Time_TimeZone$name(r)),
				_1: {ctor: '[]'}
			});
		var hours = A2(_elm_lang$core$List$range, 0, 23);
		var zdtNow = A2(
			_elm_community$elm_time$Time_ZonedDateTime$setMinute,
			0,
			A2(_elm_community$elm_time$Time_ZonedDateTime$fromTimestamp, r, time));
		var viewHour = function (h) {
			var hour = _elm_lang$core$Basics$toString(
				_elm_community$elm_time$Time_ZonedDateTime$hour(
					A2(_elm_community$elm_time$Time_ZonedDateTime$addHours, h, zdtNow)));
			return A2(
				_elm_lang$html$Html$td,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('tz-hour'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(
							A2(_elm_lang$core$Basics_ops['++'], 'hour-', hour)),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], hour, ':00')),
					_1: {ctor: '[]'}
				});
		};
		return A2(
			...
			{ctor: '[]'},
			{
				ctor: '::',
				_0: label,
				_1: A2(_elm_lang$core$List$map, viewHour, hours)
			});
	});
var _user$project$Main$viewRows = F2(
	function (rows, time) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$viewTimezone(time),
				rows));
	});
var _user$project$Main$viewConfig = function () {
	var customizedLi = F3(
		function (keySelected, mouseSelected, tz) {
			return {
				attributes: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'is-selected', _1: keySelected || mouseSelected},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
				...
				children: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_community$elm_time$Time_TimeZone$name(tz)),
					_1: {ctor: '[]'}
				}
			};
		});
	return _thebritican$elm_autocomplete$Autocomplete$viewConfig(
		{
			toId: _elm_community$elm_time$Time_TimeZone$name,
			ul: {
				ctor: '::',
...
var _user$project$Main$normalizeString = function (s) {
	var underscoreToSpace = function (ch) {
		var _p0 = ch;
		if (_p0.valueOf() === '_') {
...
var _user$project$Main$init = {
	rows: {ctor: '[]'},
	autocomplete: _thebritican$elm_autocomplete$Autocomplete$empty,
	query: '',
	showMenu: false,
	now: 0
};
var _user$project$Main$allZones = A2(
	_elm_lang$core$List$map,
	function (x) {
		return x(
			{ctor: '_Tuple0'});
	},
	_elm_lang$core$Dict$values(_elm_community$elm_time$Time_TimeZones$all));
var _user$project$Main$filterZones = function (query) {
	return A2(
		_elm_lang$core$List$filter,
		function (_p1) {
			return A2(
				_elm_lang$core$String$contains,
				_user$project$Main$normalizeString(query),
				_user$project$Main$normalizeString(
					_elm_community$elm_time$Time_TimeZone$name(_p1)));
		},
		_user$project$Main$allZones);
};
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {rows: a, autocomplete: b, query: c, showMenu: d, now: e};
	});
var _user$project$Main$GotTime = function (a) {
	return {ctor: 'GotTime', _0: a};
};
var _user$project$Main$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};
var _user$project$Main$SelectZone = function (a) {
	return {ctor: 'SelectZone', _0: a};
};
var _user$project$Main$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		toId: _elm_community$elm_time$Time_TimeZone$name,
		onKeyDown: F2(
			function (code, maybeId) {
				return _elm_lang$core$Native_Utils.eq(code, 13) ? A2(
					_elm_lang$core$Maybe$map,
					_user$project$Main$SelectZone,
					A2(_elm_lang$core$Maybe$andThen, _elm_community$elm_time$Time_TimeZones$fromName, maybeId)) : _elm_lang$core$Maybe$Nothing;
			}),
		onTooLow: _elm_lang$core$Maybe$Nothing,
		onTooHigh: _elm_lang$core$Maybe$Nothing,
		onMouseEnter: function (_p2) {
			return _elm_lang$core$Maybe$Nothing;
		},
		...
		onMouseClick: function (id) {
			return A2(
				_elm_lang$core$Maybe$map,
				_user$project$Main$SelectZone,
				_elm_community$elm_time$Time_TimeZones$fromName(id));
		},
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								query: '',
								showMenu: false,
								rows: {ctor: '::', _0: _p4._0, _1: model.rows}
							}),
						{ctor: '[]'});
				case 'SetAutoState':
					var _p5 = A5(_thebritican$elm_autocomplete$Autocomplete$update, _user$project$Main$updateConfig, _p4._0, 10, model.autocomplete, _user$project$Main$allZones);
					var newState = _p5._0;
					var maybeMsg = _p5._1;
...
var _user$project$Main$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$SetAutoState, _thebritican$elm_autocomplete$Autocomplete$subscription);
};
var _user$project$Main$viewMenu = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_user$project$Main$SetAutoState,
				A4(
					_thebritican$elm_autocomplete$Autocomplete$view,
					_user$project$Main$viewConfig,
					10,
					model.autocomplete,
					_user$project$Main$filterZones(model.query))),
			_1: {ctor: '[]'}
		});
};
		...
		A2(
			...
			function (code) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(
					_user$project$Main$SetQuery(model.query)) : _elm_lang$core$Result$Err('not handling that key');
			},
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Compare Working Hours'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$viewRows, model.rows, model.now),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('Add timezone'),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: model.showMenu ? _user$project$Main$viewMenu(model) : A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								{ctor: '[]'}),
							_1: {ctor: '[]'}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Task$perform, _user$project$Main$GotTime, _elm_lang$core$Time$now),
				_1: {ctor: '[]'}
			}),
